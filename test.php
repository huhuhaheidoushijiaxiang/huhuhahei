	...
	if($s==$b){
		...
		for($i=$m;$i>=0;$i--){
			...
			if($s==$p){
				...
				return pdd($s-$p,$i,$str.$p.';<br/>');
			}
		}
	}else{
		return '不在规定范围之内00123。';
	}

}
$er = 2**53-1;
echo pdd($er,800);exit;
?>
...
console.log(pdd(898989999999999999565464));
</script> 
</head>
<body>
<p>
